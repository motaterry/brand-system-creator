# Component Specifications for Rota do Peso

UI component guidelines and specifications.

## Design System Foundation

These components are built on the design tokens defined in the `/tokens` folder.

**Refer to:**
- `tokens.css` for CSS variables
- `figma-tokens.json` for Figma Tokens plugin
- `tokens.js` for JavaScript/React implementations
...
- **Button Text:** Keep concise: 1-3 words
- **Tone:** Caring, action-oriented
...
- **Validation:** Clear, direct error messages
...
<header class="header">
  <div class="header-container">
    <a class="logo" href="/">
      <img src="logo.svg" alt="Rota do Peso" />
    </a>
    <nav class="nav-menu">
...
**Tone:** Warm, Clear, Reassuring, Concise, Expert, Educational
**Personality:** Caring, Trustworthy, Approachable, Authoritative

**Microcopy Guidelines:**
- Button text: Keep to 1-3 words
- Error messages: Clear and direct
- Help text: Informative and guiding
...
- [ ] Component matches brand personality: Caring
- [ ] Loading and error states handled gracefully
- [ ] Works in major browsers (Chrome, Firefox, Safari, Edge)

---

**Remember:** These components should feel Calming and Trustworthy while maintaining Care in every interaction.